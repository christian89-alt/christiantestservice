    ...
    <div id="root">
        <div id="topnav" class="topnav">
          ...
          <nav role="navigation" id="topnav_menu">
            <a class="topnav_link" href="offshore.html">OFFSHORE</a>
            <a class="topnav_link" href="/administratif">ADMINISTRATIF </a>
            <a class="topnav_link" href="web-developpement.html">WEB  </a>
            <a class="topnav_link" href="web-developpement.html">GESTION DE PROJET  </a>
            <a class="topnav_link" href="contact-us.html">CONTACT</a>
          </nav>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product__description">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                    <h4>Développement offshore</h4>
                                                    <img src="img/pexels-fauxels-3184465.jpg" class="img-fluid">
                                                    ...
                                                    <a href="#" class="btn tm-btn-gray">MES OFFRES </a>
