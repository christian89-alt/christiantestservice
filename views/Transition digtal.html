                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6 col-lg-6 col-md-col-xl-6 mb-md-0 mb-sm-4 mb-4 tm-site-header-col">
                        <div class="tm-site-header">
                            ...
                            <p>Spécialiste du batiment, je vous accompagne dans la gestion de votre entreprise.</p>        
                        </div>                        
                    </div>
                                        ...
                                        <div class="product__description">
                                            <div class="row mb-3">
                                                <div class="col-12">
                                                    ...
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit perspiciatis labore aliquid minus earum molestiae culpa enim nisi, possimus placeat pariatur ducimus consequuntur repellat soluta quas illo id eius dolor.</p>        
                                                </div>
                                            </div>                                        
                                            <div class="row">
                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                    ...
                                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur natus qui dolore, reiciendis temporibus perferendis molestiae esse alias a sunt, suscipit animi? Adipisci esse libero laborum sed! Similique, perferendis facilis.</p>
                                ...
                                <div class="grid__item">
                                    <div class="product">
                                        <div class="tm-nav-link">
                                            ...
                                            <span class="tm-nav-text">Notre blog</span>
                                            <div class="product__bg"></div>             
                                        </div>                                                                 
                                        <div class="product__description">
                                            <div class="p-sm-4 p-2">
                                                <div class="row mb-3">
                                                    <div class="col-12">
                                                        <h2 class="tm-page-title">Notre actue</h2>        
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-12">
