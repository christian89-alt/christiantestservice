...
<body id="top">
  ...
  <nav class="navbar navbar-default templatemo-nav" role="navigation">
    <div class="container">
      <div class="navbar-header">
        ...
        <a href="#" class="navbar-brand">Offshore Services</a>
      </div>
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="./agence_commerciale.html">ADMINISTRATIF</a></li>
  ...
  <section class="dark">
    <div class="container py-4">
      <h1 class="h1 text-center" id="pageHeaderTitle">Mes services web</h1>

      <article class="postcard dark blue">
        <a class="postcard__img_link" href="#">
          <img class="postcard__img" src="./assets/img/ben-griffiths-Bj6ENZDMSDY-unsplash.jpg" alt="Image Title" />
        </a>
        <div class="postcard__text">
          <h1 class="postcard__title blue"><a href="#">Développement web</a></h1>
      ...
      <article class="postcard dark red">
        <a class="postcard__img_link" href="#">
          <img class="postcard__img" src="./assets/img/iphone-6-458151_640.jpg" alt="Image Title" />
        </a>
        <div class="postcard__text">
          <h1 class="postcard__title red"><a href="#">Développement mobile</a></h1>
          <div class="postcard__subtitle small">
            <time datetime="2020-05-25 12:00:00">
              <i class="fas fa-calendar-alt mr-2"></i>Mon, May 25th 2020
            </time>
      ...
      <article class="postcard dark green">
        <a class="postcard__img_link" href="#">
          <img class="postcard__img" src="./assets/img/wordpress-588495_640.jpg" alt="Image Title" />
        </a>
        <div class="postcard__text">
          <h1 class="postcard__title green"><a href="#">Spécialiste WordPress</a></h1>
          <div class="postcard__subtitle small">
            <time datetime="2020-05-25 12:00:00">
              <i class="fas fa-calendar-alt mr-2"></i>Mon, May 25th 2020
            </time>
